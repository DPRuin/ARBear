...
protocol HFPageCollectionViewDelegate: class {
...
class HFPageCollectionView: UIView {
    ...
    weak var delegate: HFPageCollectionViewDelegate?
...
extension HFPageCollectionView : UICollectionViewDelegate{
    ...
    func collectionView(_ collectionView: UICollectionView, didSelectItemAt indexPath: IndexPath) {
        delegate?.pageCollectionView(self, collectionView, didSelectItemAt: indexPath)
    }
